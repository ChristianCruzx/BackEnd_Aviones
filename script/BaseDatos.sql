CONN system/root
DROP USER SISGESACA_DB CASCADE;
CREATE USER SISGESACA_DB IDENTIFIED BY SISGESACA_DB1234;
GRANT dba TO SISGESACA_DB;

CONN SISGESACA_DB/SISGESACA_DB1234
--------------------------------------------------------------------------------------------------------------------
--TABLAS
...
INSERT INTO CARRERA VALUES('FIL','Filosofia','Escuela de Filosofia y Letras');
INSERT INTO CARRERA VALUES('EIF','Ingenieria en Sistemas de Informacion','Escuela de Informatica');
INSERT INTO CARRERA VALUES('FIS','Fisica','Escuela de Ciencias Exactas');
INSERT INTO CARRERA VALUES('ART','Arte y Comunicacion Visual','Escuela de Bellas Artes');
INSERT INTO CARRERA VALUES('AGR','Agricultura','Escuela de Biologia');
INSERT INTO CARRERA VALUES('ADM','Administracion de Empresas','Escuela de Ciencias Politicas');
INSERT INTO CARRERA VALUES('VET','Medicina Veterinaria','Escuela de Medicina Veterinaria');
INSERT INTO CARRERA VALUES('MAT','Matematica Pura','Escuela de Ciencias Exactas');
INSERT INTO CARRERA VALUES('ECO','Economia Internacional','Escuela de Economia');
INSERT INTO CARRERA VALUES('PSI','Psicologia','Escuela de Psicologia');
INSERT INTO CARRERA VALUES('FMA','Fisicamate','Escuela de Ciencias Exactas');

INSERT INTO CURSO VALUES('PLA','FIL','1','Dialogos de Platon',4,8);
INSERT INTO CURSO VALUES('FUN','EIF','2','Fundamentos de Informatica',3,6);
INSERT INTO CURSO VALUES('TER','FIS','3','Termodinamica',4,8);
INSERT INTO CURSO VALUES('MOD','ART','1','Modelado de Arcilla',2,4);
INSERT INTO CURSO VALUES('FAN','VET','2','Fisiologia Animal',3,6);
INSERT INTO CURSO VALUES('CAL','MAT','3','Calculo Vectorial',4,8);
INSERT INTO CURSO VALUES('GLO','ECO','1','Globalizacion en America',3,6);
INSERT INTO CURSO VALUES('INT','PSI','2','Instrospeccion de la Mente',2,4);
INSERT INTO CURSO VALUES('LEY','FMA','3','Leyes de Newton',2,8);